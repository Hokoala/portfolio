<?php
    ...
    if ($erreurs ==0) {
        ...
        $subject='Demande de '.$prenom.' '.$nom.' pour une '.$radio;
        $headers['From']="mmi23e10@mmi-troyes.fr";							// Pour pouvoir répondre à la demande de contact
        ...
        $email_dest="mmi23e10@mmi-troyes.fr";

        $email2_dest=$email;
        $message2="Bonjour '.$prenom.' '.$nom.',
Nous avons bien reçu votre demande de contact pour un service
